...
public class Utils {
    ...
    public static boolean handleMenuOption(Activity activity, MenuItem item) {
		...
		case R.id.optAddAccount :
			  intent = new Intent(activity,ThemTaiKhoan.class);
			  activity.startActivity(intent);
			  break;
		case R.id.optAddTransaction :
			  intent = new Intent(activity,ThemGiaoDich.class);
			  activity.startActivity(intent);
			  break;
			  
		case R.id.optSearchTransactions :
			  intent = new Intent(activity,TimKiemGiaoDich.class);
			  activity.startActivity(intent);
			  break;
		case R.id.optListAccounts :
			  intent = new Intent(activity,DanhSachTaiKhoan.class);
			  activity.startActivity(intent);
			  break;			  
			  
		case R.id.optRecentTransactions :
			  intent = new Intent(activity,DanhSachGiaoDichGanDay.class);
			  activity.startActivity(intent);
			  break;			  
		}
		return true;
