...
public class Database {
	...
	public static TaiKhoan cursorToAccount(Cursor accounts) {
	...
	public  static void populateAccounts(Spinner spinnerAccounts) {
		...
		while (accounts.moveToNext()) {
			TaiKhoan account =  Database.cursorToAccount(accounts);
			list.add(account);
		}
		accounts.close();
		db.close();
		...
		ArrayAdapter<TaiKhoan> adapter = new ArrayAdapter<TaiKhoan>(context, android.R.layout.simple_spinner_item,list);
	...
	public static String getAccountId(Spinner spinnerAccounts) {
         TaiKhoan account = (TaiKhoan) spinnerAccounts.getSelectedItem();
	...
	public static boolean addTransaction(Context context, String accountId, String transType, String transDate, String transAmount) {
