...
public class DanhSachTaiKhoan extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listAccounts.setOnItemClickListener( new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View selectedView, int arg2,long arg3) {
				...
				Intent intent = new Intent(DanhSachTaiKhoan.this, CapNhatTaiKhoan.class);
	...
	public void onStart() {
		...
		try {
			...
			SimpleCursorAdapter ca  = new SimpleCursorAdapter(this,R.layout.taikhoan, accounts,from,to);
	...
	{
		Intent intent = new Intent(this,ThemTaiKhoan.class);
    	startActivity(intent);
	}
	
	public void addTransaction(View v)
	{
		Intent intent = new Intent(this,ThemGiaoDich.class);
    	startActivity(intent);
	}
	...
	{
		Intent intent = new Intent(this,DanhSachGiaoDichGanDay.class);
    	startActivity(intent);
	}
}
